...
return array(
    'textString' => 'Rimanendo sul sito, l`utente accetta l`utilizzo dei cookie',
    'moreInfo'   => 'Maggiori informazioni',
    'Okay'       => 'informazioni accettare e chiudere',
    'title'      => 'Privacy police',
    'content'    => '
<h4>What information do we collect about you and how do we use it?</h4>
<h2>How We Use Your Personal Information</h2>
<ol>
<li>When you register for ' . SITEURL . ' services, we will ask you to provide personal information such as name and email. This data is stored in our secure databases.</li>
<li>Upon logging into your account, as well as site navigation, we collect an ip address as well as the date and time. Server logs also capture information such as referer, browser type and request.</li>
<li>We use cookies, sessions and other tracking technologies to maintain the state of the user interaction. We also use these methods to store personal preferences in order to enhance the user experience.</li>
<li>Some of our third party advertisers set cookies on your machine to track user interaction. These cookies are subject to the privacy policies of these companies. These advertisers do not have access to the ' . SITEURL . ' cookies.</li>
<li>We do not sell, rent, or lease our customer lists to third parties. Member emails are used to send activation links, site updates and violation notices.</li>
<li>' . SITEURL . ' never sends SPAM emails. If you get one which looks like it is coming from us, it is likely a fake.</li>
</ol>
<h2>Cookies</h2>
...
<h2>Additional Information You Should Know About Third Parties</h2>
<p>
...
<h2>What choices do you have about the collection and use of your personal information?</h2>
<h4>Control of Your Information</h4>
<p>
